...
<template>
  <div>
    ...
    <form @submit.prevent="handleSubmit" class="space-y-6">
      <!-- Error message -->
      <UAlert data-test="error" v-if="error" color="red" variant="soft" :title="error" icon="heroicons:exclamation-triangle-20-solid" />
      ...
      <p class="text-center text-sm text-gray-600 dark:text-gray-400">
        ...
        <NuxtLink to="/auth/register" class="text-primary-600 hover:text-primary-500 font-medium"> Sign up </NuxtLink>
      </p>
    </form>
  </div>
</template>
