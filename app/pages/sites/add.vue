      ...
      <div class="card p-6">
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div>
            ...
            <UInput v-model="form.checkInterval" type="number" min="30" max="3600" :error="errors.checkInterval" />
            <p v-if="errors.checkInterval" class="mt-1 text-sm text-error-600">
              {{ errors.checkInterval }}
            </p>
            <p class="mt-1 text-xs text-gray-500">How often to check this site (30-3600 seconds)</p>
          </div>
          ...
          <div v-if="form.check_type === 'text'">
            ...
            <UInput v-model="form.expected_text" placeholder="e.g. Welcome" :error="errors.expected_text" />
